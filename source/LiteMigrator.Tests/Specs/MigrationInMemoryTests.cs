...
public sealed class MigrationInMemoryTests : BaseTest
{
  ...
  public async Task GetMigrationScriptsTestAsync()
  {
    ...
    var migrator = new LiteMigration(ScriptNamespace, Assembly.GetExecutingAssembly());
  ...
  {
    using (var migrator = new LiteMigration(ScriptNamespace, Assembly.GetExecutingAssembly()))
    {
      // Act
